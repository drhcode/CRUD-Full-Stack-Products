            ...
            <div className='flex flex-col items-center w-full md:flex-row md:w-1/2'>
              ...
              <div className='max-w-lg md:mx-12 md:order-2'>
                ...
                <p className='mt-4 text-gray-600 dark:text-gray-300'>
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aut quia asperiores
                  alias vero magnam recusandae adipisci ad vitae laudantium quod rem voluptatem eos
                  accusantium cumque.
                </p>
                <div className='mt-6'>
                  <a
